    ...
    .defines(function () {
        EntityGameControl = ig.Entity.extend({
                        ...
                        if (ig.input.mouse.y >= 287 && ig.input.mouse.y <= 344) {
                            ...
                            if (this.isDragonLeft == 0) {
                                ...
                                setTimeout(() => {
                                    this.isDragonLeft = 1;
                                    this.isDragonFirstTimeClicked = 1;
                                    this.tween({ breedDragonX: 480 }, 0.4, {

                                        onComplete: function () {
                                            console.log("complete");
                                            this.breedDragonLeft = 1;
                                            this.tween({ breedDragonX: 280 }, 0.4, {
                                                onComplete: function () {
                        ...
                        if (ig.input.mouse.y >= 166 && ig.input.mouse.y <= 236) {
                            ...
                            if (this.isDragonLeft == 0) {
                                ...
                                setTimeout(() => {
                                    this.isDragonLeft = 1;
                                    this.isDragonFirstTimeClicked = 1;
                                    this.tween({ breedDragonX: 580 }, 0.4, {
                                        
                                        onComplete: function () {
                                            console.log("complete");
                                            this.breedDragonLeft = 1;
                                            this.tween({ breedDragonX: 300 }, 0.4, {
                                                onComplete: function () {
                                                    this.breedDragonLeft = 0;
                                                    this.boolUnlockElevator = 0;
                                                    this.boolUnlockCart = 1;
            ...
            BreedAnimate: function () {
                ...
                this.tween({ breedDragonX: this.breedDragonX + 90}, 0.4
                    , {
                    onComplete: function () {
                    }.bind(this)
                    }).start();
